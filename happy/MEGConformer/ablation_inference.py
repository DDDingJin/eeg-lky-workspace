...
Usage:
    ...
    # 测试所有实验
    python ablation_inference.py --models Exp-00 Exp-01 Exp-02 Exp-03 Exp-04 Exp-05 Exp-06 Exp-07 Exp-08 Exp-09 Exp-10 Exp-11
"""
...
# ========== 模型别名配置 ==========
DEFAULT_ALIASES = {
    'Exp-00': 'test_results/conformer_v2_nlayer4_dmodel256_nhead4_gscale1.0_dist_20260405_152418',
    'Exp-01': 'test_results/Exp-01',
    'Exp-02': 'test_results/Exp-02',
    'Exp-03': 'test_results/Exp-03',
    'Exp-04': 'test_results/Exp-04',
    'Exp-05': 'test_results/Exp-05',
    'Exp-06': 'test_results/Exp-06',
    'Exp-07': 'test_results/Exp-07',
    'Exp-08': 'test_results/Exp-08',
    'Exp-09': 'test_results/Exp-09',
    'Exp-10': 'test_results/Exp-10',
    'Exp-11': 'test_results/Exp-11',
}
...
def load_model_from_checkpoint(checkpoint_path, device, sensor_pos=None):
    """加载模型"""
    ...
    model = Decoder(
        ...
        use_conv_module=get_arg('use_conv_module', True),
        use_spatial_gat=get_arg('use_spatial_gat', False),
        gat_n_heads=get_arg('gat_n_heads', 4),
        gat_d_head=get_arg('gat_d_head', 32),
...
def main():
    ...
    import scipy.io
    sensor_pos = None
    if os.path.exists(args.sensor_pos_file):
        mat = scipy.io.loadmat(args.sensor_pos_file)
        sensor_pos = mat['pos']  # [64, 3]
        print(f"传感器坐标已加载: {args.sensor_pos_file}")
    else:
        print(f"警告: 传感器坐标文件不存在 {args.sensor_pos_file}，GAT模型将使用零矩阵占位")
    ...
    for model_alias in models_to_test:
        ...
        try:
            ...
            # 加载模型
            model, model_args = load_model_from_checkpoint(checkpoint_path, device, sensor_pos=sensor_pos)
            ...
            result = {
                ...
                'model_config': {
                    ...
                    'use_conv_module': model_args.get('use_conv_module'),
                    'use_spatial_gat': model_args.get('use_spatial_gat'),
                    'conv_kernel_size': model_args.get('conv_kernel_size'),
                },
                'results': {
