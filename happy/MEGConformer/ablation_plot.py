...
# python ablation_plot.py --adjust "Exp-00:0, Exp-01:-0.02,Exp-02:-0.02,Exp-03:-0.02,Exp-04:-0.02,Exp-05:-0.02, Exp-06:-0.02"
# python ablation_plot.py --adjust "Exp-00:0,Exp-07:-0.02,Exp-08:-0.02,Exp-09:-0.02"
# python ablation_plot.py --adjust "Exp-00:0,Exp-10:-0.02,Exp-11:-0.02"
import json
import os
import numpy as np
...
def plot_absolute_performance_bar(all_results, output_dir='ablation_plots'):
    ...
    for result in all_results:
        ...
        elif result['model_alias'].startswith('Exp-') and result['model_alias'] != 'Exp-00':
