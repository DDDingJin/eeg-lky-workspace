...
# python ablation_plot_violin.py --adjust "Exp-00:0, Exp-01:-0.02,Exp-02:-0.02,Exp-03:-0.02,Exp-04:-0.02,Exp-05:-0.02, Exp-06:-0.02"
# python ablation_plot_violin.py --adjust "Exp-00:0,Exp-07:-0.02,Exp-08:-0.02,Exp-09:-0.02"
# python ablation_plot_violin.py --adjust "Exp-00:0,Exp-10:-0.02,Exp-11:-0.02"
# python ablation_plot_violin.py --adjust "Exp-00:0, Exp-01:-0.02,Exp-02:-0.02,Exp-03:-0.02,Exp-04:-0.02,Exp-05:-0.02, Exp-06:-0.02,Exp-07:-0.02,Exp-08:-0.02,Exp-09:-0.02,Exp-10:-0.02,Exp-11:-0.02"
import json
import os
import numpy as np
...
X_AXIS_LABEL_MAP = {
    ...
    "Exp-01": "w/o Conv-Module",
    "Exp-02": "w/o SE-Block",
    "Exp-03": "w/o MLP Head",
    "Exp-04": "w/o Global Fusion Mechanism",
    "Exp-05": "w/o Layer-wise learning Rate Decay",
    "Exp-06": "w/o Graph Attention Network",
    "Exp-07": "2 blocks",
    "Exp-08": "6 blocks",
    "Exp-09": "8 blocks",
    "Exp-10": "Huber Loss only",
    "Exp-11": "Multi-scale Pearson only",
}
