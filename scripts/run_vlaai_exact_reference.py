...
from repro.vlaai_exact import train_vlaai_exact_reference
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=ROOT / "experiments" / "vlaai_exact_reference" / "hugo_sample_tf64",
    )
...
def main() -> int:
    ...
    _, summary = train_vlaai_exact_reference(
        args.input_dir,
